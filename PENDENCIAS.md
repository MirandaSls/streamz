...
## 1c. Giphy (bloqueia só a busca de GIF)
...
- [ ] Pegar uma chave gratuita em
      [developers.giphy.com](https://developers.giphy.com/dashboard) — app do tipo
      "API", não "SDK" — e preencher `GIPHY_API_KEY` no `.env`.
- [ ] Trocar o texto "Powered by GIPHY" do seletor (`GifPicker.tsx`) pelo selo
      oficial em imagem, que é o que os termos do Giphy pedem (ver ADR-0006).
