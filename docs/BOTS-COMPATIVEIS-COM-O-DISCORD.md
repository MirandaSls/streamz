...
`flags: 64` é entregue de verdade: só quem invocou o comando recebe, pelo
socket, e a mensagem não entra no histórico do canal. O desenho, a decisão de
armazenamento e o que ela não tem estão no §9; a prova é o passo 6 do
`prova.sh`.
