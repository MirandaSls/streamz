...
export class EmojisService {
  ...
  /**
   * Quem pode mexer nos emojis do servidor.
   *
   * TODO(agente C): trocar por `MANAGE_EMOJIS` do bitfield de permissões quando
   * os cargos personalizados existirem. Até lá vale a moderação (dono/admin),
   * que é o teto atual do projeto.
   */
