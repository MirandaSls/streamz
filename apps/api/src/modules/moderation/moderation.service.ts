...
import { WS_EVENTS, MAX_BULK_DELETE, MAX_MODERATION_REASON } from "@newdisc/shared";
...
export class ModerationService {
  ...
  private async assertPodeAgirSobre(actorId: string, guildId: string, targetUserId: string) {
    ...
    const actor = await this.guilds.assertCanModerate(actorId, guildId);
