-- Nota da integração r2: não há enum "MessageSystemType" nem coluna
-- "Message"."systemType". A narração do sistema usa o enum único
-- "MessageType" (criado pela migration de a-mensagens, que já traz
-- SYSTEM_JOIN e SYSTEM_MOD_NOTICE). Ver packages/shared e common/enums.ts.
