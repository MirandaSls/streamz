-- CreateEnum
CREATE TYPE "MessageType" AS ENUM ('DEFAULT', 'SYSTEM_PIN', 'SYSTEM_JOIN', 'SYSTEM_MEMBER_ADDED', 'SYSTEM_MEMBER_REMOVED', 'SYSTEM_MEMBER_LEFT', 'SYSTEM_GROUP_RENAMED', 'SYSTEM_GROUP_ICON');
