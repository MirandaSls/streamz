-- Nota da integração r2: o enum "MessageType" e a coluna "Message"."type"
-- são criados pela migration de a-mensagens, que já traz os valores de grupo
-- desta frente. Ver packages/shared (MessageType) e common/enums.ts.
