...
export default function DMList() {
  ...
  return (
    <aside className="flex w-[294px] shrink-0 flex-col bg-panel">
      <div className="flex h-[49px] shrink-0 items-center border-b border-border px-2.5 shadow-header celular:h-[56px]">
        <input
          value={query}
          ...
          className={
            "h-8 w-full rounded-lg bg-hov px-1.5 text-sm text-txt-normal outline-none placeholder:text-txt-muted celular:h-[44px] celular:px-3 " +
      ...
      <div role="list" aria-label="Conversas" className="flex-1 overflow-y-auto pb-[78px] pt-2">
        ...
        <button
          ...
          className={"mx-2 flex h-10 w-[calc(100%-1rem)] items-center gap-3 rounded-lg pl-3 pr-2 text-left celular:h-[48px] " + (friendsOpen ? "bg-sel text-txt-primary" : "text-txt-faint hover:bg-hov hover:text-txt-normal")}
        >
        ...
        <div className="group flex items-center justify-between pl-5 pr-3.5 pt-3 pb-0.5">
          ...
          <Tooltip label="Nova conversa">
            <button
              ...
              className="text-txt-muted transition hover:text-txt-primary celular:-my-2.5 celular:-mr-3 celular:grid celular:h-[44px] celular:w-[44px] celular:place-items-center"
            >
              <Plus size={20} />
            </button>
          </Tooltip>
