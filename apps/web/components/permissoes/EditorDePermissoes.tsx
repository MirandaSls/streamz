              ...
              <div className="mb-1 flex items-center justify-between gap-2 px-2">
                ...
                <Tooltip label="Adicionar cargo ou membro">
                  <button
                    ...
                    className="grid h-5 w-5 shrink-0 place-items-center rounded-full text-txt-muted transition hover:bg-hov hover:text-txt-primary"
                  >
                    <Plus size={14} />
                  </button>
                </Tooltip>
              ...
              <ul>
                {alvos.map((alvo) => {
                  ...
                  return (
                    <li
                      key={alvo.chave}
                      className={`group mb-0.5 flex h-8 items-center rounded-[4px] pr-1 transition ${
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`flex h-8 min-w-0 flex-1 items-center gap-2 rounded-[4px] px-2 text-left text-sm ${
                      ...
                      {!alvo.padrao && (
                        <button
                          ...
                          className="grid h-5 w-5 shrink-0 place-items-center rounded text-txt-muted opacity-0 transition hover:text-red focus-visible:opacity-100 group-hover:opacity-100"
                        >
                          <X size={12} />
                        </button>
                      )}
