...
import { CALL_RING_TIMEOUT_MS, displayNameOf } from "@newdisc/shared";
...
export default function IncomingCallModal() {
  ...
  const onde = conversa ? dmTitle(conversa) : nome;
  ...
  return (
    <Dialog title="Chamada recebida" onClose={decline} className="w-[360px]">
      ...
      <div className="flex flex-col items-center gap-3 py-2">
        ...
        <p className="text-sm text-txt-muted">Chamando em {onde}…</p>
      </div>
