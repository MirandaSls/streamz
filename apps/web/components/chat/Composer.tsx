...
export default function Composer({
  ...
  // TODO(agente C): trocar por `MENTION_EVERYONE` do bitfield de permissões.
  const podeMencionarTodos = useCanModerate(me?.id);
  ...
  async function submit() {
    ...
    if (comando.tipo === "apelido") {
      // TODO(agente C): chamar a rota de apelido quando os cargos existirem
