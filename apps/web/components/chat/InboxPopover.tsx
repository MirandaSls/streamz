    ...
    <HeaderPopover
      ...
      cabecalho={(fechar) => (
        <header className="shrink-0">
          ...
          <div className="flex h-9 items-center gap-2 px-[21px] pt-[19px] max-md:h-11 max-md:px-4">
            ...
            <div className="ml-auto flex shrink-0 items-center gap-2">
              ...
              <Tooltip label="Ver pedidos de amizade" side="bottom">
                <button
                  ...
                  className="flex h-8 w-[58px] items-center justify-center gap-1 rounded-lg bg-hov text-txt-secondary transition hover:bg-sel hover:text-txt-primary max-md:h-11 max-md:w-[66px]"
                >
  ...
  return (
    <Tooltip label={inerte ? `${label} (em breve)` : label} side="bottom">
      <button
        ...
        className={`grid h-8 w-8 place-items-center rounded-lg bg-hov transition max-md:h-11 max-md:w-11 ${
          inerte
