...
export default function GroupSettingsModal({ channelId }: { channelId: string }) {
  ...
  return (
    <JanelaDeConfiguracoes
      // Mesma moldura das configurações de canal e de categoria (print
      // `2026-09-04 102238`: tela cheia, círculo "ESC"). Sem print desta tela
      // (ver o cabeçalho), vale a irmã: sem a prop caía na `janela`, o modal
    ...
    >
      ...
      {aba === "convites" && (
        <>
          <TituloDaPagina titulo={ROTULO.convites} />
          <div className="space-y-6">
            {/*
