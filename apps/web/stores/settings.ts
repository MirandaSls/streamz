...
/** Como a voz é transmitida (o agente F implementa o PTT; aqui é a preferência). */
export type VoiceMode = "activity" | "ptt";
...
export interface SettingsValues {
  ...
  outputVolume: number;
  voiceMode: VoiceMode;
  /** tecla do push-to-talk, no formato de `lib/shortcuts` (ex.: "Ctrl+Space"). */
