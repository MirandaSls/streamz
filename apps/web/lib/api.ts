...
export const api = {
  ...
  pedirAutocompleteDeComando: (channelId: string, body: PedidoDeAutocompleteInput) =>
    request<InteracaoDeBotCriada>(`/channels/${channelId}/interactions/autocomplete`, json(body)),
